	...
	<xsl:template match="*/gmd:resourceConstraints">
		<xsl:if test="not(./eamp:EA_Constraints)">
			<xsl:for-each select="./gmd:MD_LegalConstraints/gmd:otherConstraints/gco:CharacterString">				
				...
				<xsl:variable name="nelicensetext"><xsl:value-of select="concat('Terms of Use for Natural England',$apos,'s Information and Data')"></xsl:value-of></xsl:variable>
				<xsl:if test="contains(.,$nelicensetext)">
					<gmd:resourceConstraints>
						<gmd:MD_Constraints>
							<gmd:useLimitation>
								<gco:CharacterString><xsl:value-of select="."></xsl:value-of></gco:CharacterString>
			...
			<gmd:CI_Contact>
			  ...
			  <gmd:onlineResource>
				<gmd:CI_OnlineResource>
				  ...
				  <gmd:description>
					<gco:CharacterString>Natural England Website</gco:CharacterString>
				  </gmd:description>
				</gmd:CI_OnlineResource>
			  </gmd:onlineResource>
			</gmd:CI_Contact>
