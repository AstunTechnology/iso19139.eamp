...
<xsl:template match="//gmd:MD_LegalConstraints | //*[@gco:isoType='gmd:MD_LegalConstraints']"
      ...
      -->
<xsl:choose>
         <xsl:when test="(count(gmd:accessConstraints/*[@codeListValue = 'otherRestrictions']) &gt;= 1 and                   count(gmd:otherConstraints) &gt;= 1) or                   count(gmd:accessConstraints/*[@codeListValue = 'otherRestrictions']) = 0"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" ref="#_{geonet:element/@ref}"
                                test="(count(gmd:accessConstraints/*[@codeListValue = 'otherRestrictions']) &gt;= 1 and count(gmd:otherConstraints) &gt;= 1) or count(gmd:accessConstraints/*[@codeListValue = 'otherRestrictions']) = 0">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>
      ...
      -->
<xsl:choose>
         <xsl:when test="(count(gmd:useConstraints/*[@codeListValue = 'otherRestrictions']) &gt;= 1 and                   count(gmd:otherConstraints) &gt;= 1) or                   count(gmd:useConstraints/*[@codeListValue = 'otherRestrictions']) = 0"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" ref="#_{geonet:element/@ref}"
                                test="(count(gmd:useConstraints/*[@codeListValue = 'otherRestrictions']) &gt;= 1 and count(gmd:otherConstraints) &gt;= 1) or count(gmd:useConstraints/*[@codeListValue = 'otherRestrictions']) = 0">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>
...
<xsl:template match="//gmd:MD_LegalConstraints | //*[@gco:isoType='gmd:MD_LegalConstraints']"
      ...
      -->
<xsl:choose>
         <xsl:when test="(count(gmd:otherConstraints) = 0) or                   (count(gmd:otherConstraints[text() != '']) = 0) or                   (gmd:otherConstraints/@gco:nilReason = 'inapplicable' or                   gmd:otherConstraints/@gco:nilReason = 'missing' or                   gmd:otherConstraints/@gco:nilReason = 'template' or                   gmd:otherConstraints/@gco:nilReason = 'unknown' or                   gmd:otherConstraints/@gco:nilReason = 'withheld')"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" ref="#_{geonet:element/@ref}"
               ...
               <svrl:text>
        The '<xsl:text/>
                  <xsl:copy-of select="name(gmd:otherConstraints[0])"/>
...
<xsl:template match="//gmd:MD_ExtendedElementInformation | //*[@gco:isoType = 'gmd:MD_ExtendedElementInformation']"
      ...
      -->
<xsl:choose>
         <xsl:when test="(count(gmd:obligation) = 0) or                   (count(gmd:obligation[text() != '']) = 0) or                   (gmd:obligation/@gco:nilReason = 'inapplicable' or                   gmd:obligation/@gco:nilReason = 'missing' or                   gmd:obligation/@gco:nilReason = 'template' or                   gmd:obligation/@gco:nilReason = 'unknown' or                   gmd:obligation/@gco:nilReason = 'withheld')"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" ref="#_{geonet:element/@ref}"
                                test="(count(gmd:obligation) = 0) or (count(gmd:obligation[text() != '']) = 0) or (gmd:obligation/@gco:nilReason = 'inapplicable' or gmd:obligation/@gco:nilReason = 'missing' or gmd:obligation/@gco:nilReason = 'template' or gmd:obligation/@gco:nilReason = 'unknown' or gmd:obligation/@gco:nilReason = 'withheld')">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>
        The '<xsl:text/>
                  <xsl:copy-of select="name(gmd:obligation[0])"/>
                  <xsl:text/>' element should have a value.
      </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
...
<xsl:template match="//*" priority="1000" mode="M47">
      ...
      -->
<xsl:choose>
         <xsl:when test="substring-before(name(), concat(':', local-name())) = 'geonet' or name() = 'geonet:text' or name() = 'geonet:element' or count(*[name()!='geonet:element']) &gt; 0 or                     namespace-uri() = 'http://www.isotc211.org/2005/gco' or                     namespace-uri() = 'http://www.isotc211.org/2005/gmx' or                     namespace-uri() = 'http://www.opengis.net/gml/3.2' or                     namespace-uri() = 'http://www.opengis.net/gml' or                     @codeList or                     @codeListValue or                     local-name() = 'MD_TopicCategoryCode' or                     local-name() = 'URL' or                     local-name() = 'EA_AfaStatus' or                     (@gco:nilReason = 'inapplicable' or                     @gco:nilReason = 'missing' or                     @gco:nilReason = 'template' or                     @gco:nilReason = 'unknown' or                     @gco:nilReason = 'withheld') or                     @xlink:href"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" ref="#_{geonet:element/@ref}"
                                test="substring-before(name(), concat(':', local-name())) = 'geonet' or name() = 'geonet:text' or name() = 'geonet:element' or count(*[name()!='geonet:element']) &gt; 0 or namespace-uri() = 'http://www.isotc211.org/2005/gco' or namespace-uri() = 'http://www.isotc211.org/2005/gmx' or namespace-uri() = 'http://www.opengis.net/gml/3.2' or namespace-uri() = 'http://www.opengis.net/gml' or @codeList or @codeListValue or local-name() = 'MD_TopicCategoryCode' or local-name() = 'URL' or local-name() = 'EA_AfaStatus' or (@gco:nilReason = 'inapplicable' or @gco:nilReason = 'missing' or @gco:nilReason = 'template' or @gco:nilReason = 'unknown' or @gco:nilReason = 'withheld') or @xlink:href">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>
