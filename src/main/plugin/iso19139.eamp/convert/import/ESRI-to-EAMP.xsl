...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" 
                ...
                xmlns:esri="http://www.esri.com/schemas/ArcGIS/10.7"
    ...
    <xsl:variable name="resourceType">
        <xsl:choose>
            <xsl:when test="count(/esri:Workspace/WorkspaceDefinition[1]/DatasetDefinitions[1]/DataElement[1]/Metadata[1]/XmlDoc[1]/metadata[1]/mdHrLv[1]/ScopeCd)!=0">
                <xsl:call-template name="GetScopeCode">
                    <xsl:with-param name="esriScopeCode" select="/esri:Workspace/WorkspaceDefinition[1]/DatasetDefinitions[1]/DataElement[1]/Metadata[1]/XmlDoc[1]/metadata[1]/mdHrLv[1]/ScopeCd/@value" />
                </xsl:call-template>
            </xsl:when>
            <xsl:when test="count(/esri:Workspace/WorkspaceDefinition[1]/DatasetDefinitions[1]/DataElement[1]/Metadata[1]/XmlDoc[1]/metadata[1]/mdHrLvName[1][@Sync='TRUE'])!=0">
                <xsl:value-of select="/esri:Workspace/WorkspaceDefinition[1]/DatasetDefinitions[1]/DataElement[1]/Metadata[1]/XmlDoc[1]/metadata[1]/mdHrLvName[1]" />
            </xsl:when>
        </xsl:choose>
    </xsl:variable>
    <!-- ========================================================================== -->
    ...
    <xsl:template name="MD_Metadata">
        ...
        <xsl:call-template name="language">
            <xsl:with-param name="IsoLangCode" select="./dataLang/languageCode" />
        ...
        <xsl:call-template name="metadataContact">
            <xsl:with-param name="IsoElement" select="/esri:Workspace/WorkspaceDefinition[1]/DatasetDefinitions[1]/DataElement[1]/Metadata[1]/XmlDoc[1]/metadata[1]/distInfo/distributor/distorCont" />
    ...
    <xsl:template name="metadataNameVersion">
        <gmd:metadataStandardName>
            <gco:CharacterString>EAMP</gco:CharacterString>
        </gmd:metadataStandardName>
    ...
    <xsl:template name="fileIdentifier">
        ...
        <xsl:element name="gmd:fileIdentifier" namespace="http://www.isotc211.org/2005/gmd">
            <xsl:choose>
                <xsl:when test="count(/esri:Workspace/WorkspaceDefinition[1]/DatasetDefinitions[1]/DataElement[1]/CLSID[1])!=0">
                    <xsl:call-template name="CharacterString">
                        <xsl:with-param name="value" select="translate(/esri:Workspace/WorkspaceDefinition[1]/DatasetDefinitions[1]/DataElement[1]/CLSID[1],'{}','')" />
                    </xsl:call-template>
                </xsl:when>
                <xsl:otherwise>
                    <xsl:call-template name="CharacterString">
                    ...
                    <xsl:call-template name="CodeListAttributes">
                        ...
                        <xsl:with-param name="CodeListValue">
                            <xsl:call-template name="GetCharacterSetCode">
                                <xsl:with-param name="esriCode" select="/esri:Workspace/WorkspaceDefinition[1]/DatasetDefinitions[1]/DataElement[1]/Metadata[1]/XmlDoc[1]/metadata[1]/dataIdInfo[1]/dataChar[1]/CharSetCd[1]/@value"/>
                            </xsl:call-template>
                        </xsl:with-param>
                    </xsl:call-template>
                </xsl:element>
    ...
    <xsl:template name="metadataContact">
        ...
        <xsl:choose>
            ...
            <xsl:when test="count($FgdcElement)!=0 and not(contains($FgdcElement/cntinfo/cntperp/cntorg,'REQUIRED:'))">
    ...
    <xsl:template name="dateStamp">
        ...
        <xsl:element name="gmd:dateStamp" namespace="http://www.isotc211.org/2005/gmd">
            <xsl:element name="gco:Date" namespace="http://www.isotc211.org/2005/gco">
                <xsl:choose>
                    <xsl:when test="count(/esri:Workspace/WorkspaceDefinition[1]/DatasetDefinitions[1]/DataElement[1]/Metadata[1]/XmlDoc[1]/metadata[1]/mdDateSt[1])!=0">
                        <xsl:call-template name="FormatDate">
                            <xsl:with-param name="date" select="/esri:Workspace/WorkspaceDefinition[1]/DatasetDefinitions[1]/DataElement[1]/Metadata[1]/XmlDoc[1]/metadata[1]/mdDateSt[1]" />
                        </xsl:call-template>
                    </xsl:when>
                    ...
                    <xsl:element name="gmd:RS_Identifier" namespace="http://www.isotc211.org/2005/gmd">
                        <xsl:element name="gmd:code" namespace="http://www.isotc211.org/2005/gmd">
                            <xsl:call-template name="CharacterString">
                                <xsl:with-param name="value">
                                    <xsl:choose>
                                        <xsl:when test="count(/esri:Workspace/WorkspaceDefinition[1]/DatasetDefinitions[1]/DataElement[1]/Metadata[1]/XmlDoc[1]/metadata[1]/refSysInfo[1])!=0">
                                            <xsl:call-template name="GetEpsgCode">
                                                <xsl:with-param name="esriCode" select="/esri:Workspace/WorkspaceDefinition[1]/DatasetDefinitions[1]/DataElement[1]/Metadata[1]/XmlDoc[1]/metadata[1]/refSysInfo[1]/RefSystem/refSysID/identCode" />
                                            </xsl:call-template>
                                        </xsl:when>
    ...
    <xsl:template name="MD_DataIdentification">
        <xsl:element name="gmd:MD_DataIdentification" namespace="http://www.isotc211.org/2005/gmd">
            ...
            <!-- Responsible organisation -->
            <xsl:call-template name="responsibleOrganisation">
                <xsl:with-param name="IsoElement" select="/esri:Workspace/WorkspaceDefinition[1]/DatasetDefinitions[1]/DataElement[1]/Metadata[1]/XmlDoc[1]/metadata[1]/dataIdInfo[1]/idCitation/citRespParty" />
                <xsl:with-param name="FgdcElement" select="./idinfo/ptcontac/cntinfo" />
            </xsl:call-template>
            <!-- Distributor Contact -->
            <xsl:call-template name="responsibleOrganisation">
    ...
    <xsl:template name="abstract">
        ...
        <xsl:element name="gmd:abstract" namespace="http://www.isotc211.org/2005/gmd">
            <xsl:choose>
                <xsl:when test="count(/esri:Workspace/WorkspaceDefinition[1]/DatasetDefinitions[1]/DataElement[1]/Metadata[1]/XmlDoc[1]/metadata[1]/dataIdInfo[1]/idAbs[1])!=0">
                    <xsl:call-template name="CharacterString">
                        <xsl:with-param name="value" select="/esri:Workspace/WorkspaceDefinition[1]/DatasetDefinitions[1]/DataElement[1]/Metadata[1]/XmlDoc[1]/metadata[1]/dataIdInfo[1]/idAbs[1]/descendant::*[last()]" />
                    </xsl:call-template>
                </xsl:when>
                <xsl:when test="count(./idinfo/descript/abstract)!=0 and not(contains(./idinfo/descript/abstract,'REQUIRED:'))">
                    <xsl:call-template name="CharacterString">
            ...
            <xsl:element name="gmd:MD_MaintenanceInformation" namespace="http://www.isotc211.org/2005/gmd">
                <xsl:element name="gmd:maintenanceAndUpdateFrequency" namespace="http://www.isotc211.org/2005/gmd">
                    <xsl:choose>
                        ...
                        <xsl:when test="count(./idinfo/status/update)!=0 and not(contains(./idinfo/status/update,'REQUIRED:'))">
                            <xsl:element name="gmd:MD_MaintenanceFrequencyCode" namespace="http://www.isotc211.org/2005/gmd">
                                <xsl:call-template name="CodeListAttributes">
                                    <xsl:with-param name="CodeList">
                                        <xsl:text>MD_MaintenanceFrequencyCode</xsl:text>
        ...
        <xsl:element name="gmd:resourceConstraints" namespace="http://www.isotc211.org/2005/gmd">
            <xsl:element name="gmd:MD_LegalConstraints" namespace="http://www.isotc211.org/2005/gmd">
                <xsl:choose>
                    ...
                    <xsl:when test="count(./idinfo/accconst)!=0 and not(contains(./idinfo/accconst,'REQUIRED:'))">
    ...
    <xsl:template name="language">
        ...
        <xsl:choose>
            ...
            <xsl:when test="count($FgdcLangCode[@Sync='TRUE'])!=0 and not(contains($FgdcLangCode,'REQUIRED:'))">
                <xsl:comment>
                    <xsl:value-of select="$GeminiItemName"/>
                </xsl:comment>
                <xsl:element name="gmd:language" namespace="http://www.isotc211.org/2005/gmd">
    ...
    <xsl:template name="additionalInformationSource">
        ...
        <xsl:choose>
            ...
            <xsl:when test="count(./idinfo/descript/supplinf) > 0 and not(contains(./idinfo/descript/supplinf,'REQUIRED:'))">
                <xsl:element name="gmd:supplementalInformation" namespace="http://www.isotc211.org/2005/gmd">
                    <xsl:call-template name="CharacterString">
    ...
    <xsl:template name="FormatDate">
        ...
        <xsl:message>date = <xsl:value-of select="$date"></xsl:value-of></xsl:message>
        <xsl:choose>
